...
class QuizPage extends StatefulWidget {
  ...
  QuizPage({Key? key, required this.questions})
    ...
    setState(() {
      if (isSelected[index]) {
        ...
        if (lastSelectedAnswer ==
            widget.questions[currentQuestion]['correctAnswer']) {
          correctAnswers--;
          score--;
        } else {
          incorrectAnswers--;
        ...
        hasAnswered = true;
        unattemptedQuestions =
            unattemptedQuestions > 0 ? unattemptedQuestions - 1 : 0;
      }
    });
  }
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                _buildResultStat(
                    'CORRECT', correctAnswers, const Color(0xFFDDE0F5)),
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFFDDE0F5), // Background color
