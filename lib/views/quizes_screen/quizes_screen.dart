...
class _QuizzesPageState extends State<QuizzesPage> {
  ...
  final List<Map<String, Object>> quizOneQuestions = [
    {
      'question':
          'Why is investing important for protection against inflation?',
      'options': [
    ...
    {
      'question':
          'What would happen if the inflation rate is 6% and you leave your ₹1,000 in a savings account with a 4% interest rate?',
      'options': [
    ...
    {
      'question':
          'How much would ₹5,000 invested monthly at a 10% annual return grow to by age 60 if started at age 30?',
      'options': ['₹30 lakh', '₹50 lakh', '₹1.1 crore', '₹75 lakh'],
      'correctAnswer': 2,
    },
    {
      'question':
          'Which of the following is NOT a financial goal that can be achieved through investments?',
      'options': [
        'Buying a house',
    ...
    {
      'question':
          'What effect does more frequent compounding have on investments?',
      'options': [
    ...
    {
      'question':
          'Which of the following is an example of compounding working against you?',
      'options': [
  ...
  final List<Map<String, Object>> quizTwoQuestions = [
    ...
    {
      'question':
          'What is the primary role of a professional fund manager in mutual funds?',
      'options': [
    ...
    {
      'question':
          'Which of the following best describes how mutual fund returns are distributed to investors?',
      'options': [
    ...
    {
      'question':
          'Mutual funds in India are established under which legal framework?',
      'options': [
    ...
    {
      'question':
          'How much time should an investor give for an actively-managed equity scheme to generate reasonable returns?',
      'options': [
        '6 months',
        '12 months',
    ...
    {
      'question':
          'Which of the following describes why people invest in mutual funds?',
      'options': [
  ...
  final List<Map<String, Object>> quizThreeQuestions = [
    {
      'question':
          'Which of the following is NOT a classification basis for mutual fund schemes?',
      'options': [
    ...
    {
      'question':
          'What is the key feature of an open-ended scheme in mutual funds?',
      'options': [
    ...
    {
      'question':
          'Which of the following is an investment objective for mutual funds?',
      'options': [
        'Liquidity',
  ...
  final List<Map<String, Object>> quizFourQuestions = [
    ...
    {
      'question':
          'Which factor is NOT mentioned as directly influencing AUM in India?',
      'options': [
        'Investor Sentiment',
        'Market Conditions',
    ...
    {
      'question':
          'What is the primary purpose of an exit load in mutual funds?',
      'options': [
    ...
    {
      'question':
          'Which time is critical for calculating the applicable NAV in liquid funds?',
      'options': ['1:00 p.m.', '1:30 p.m.', '3:00 p.m.', '4:00 p.m.'],
      'correctAnswer': 1,
    },
    {
    ...
    {
      'question':
          'Which of the following is NOT considered a component of the Total Expense Ratio (TER)?',
      'options': [
    ...
    {
      'question':
          'According to SEBI regulations, what is the maximum TER for equity funds on the first ₹500 crores of AUM?',
      'options': ['2.00%', '1.50%', '2.25%', '1.75%'],
      'correctAnswer': 2,
    },
    {
      'question':
          'Which of the following types of mutual funds generally has a lower exit load?',
      'options': ['Equity funds', 'Debt funds', 'Hybrid funds', 'Index funds'],
      'correctAnswer': 1,
    },
    {
      'question':
          'In mutual funds, what price is used to buy units during an ongoing offer period?',
      'options': ['Face Value', 'Market Value', 'Sale Price', 'Applicable NAV'],
      'correctAnswer': 3,
    },
  ];
  final List<Map<String, Object>> quizFiveQuestions = [
    {
      'question':
          'Which category of mutual fund schemes primarily invests in equities and equity-related instruments?',
      'options': [
        'Debt Schemes',
        'Hybrid Schemes',
        'Equity Schemes',
    ...
    {
      'question':
          'What is the minimum investment required in equity and equity-related instruments for a Flexi Cap Fund?',
      'options': ['65%', '75%', '80%', '50%'],
      'correctAnswer': 0,
    },
    {
      'question':
          'Which type of fund follows a contrarian investment strategy?',
      'options': ['Value Fund', 'Contra Fund', 'Growth Fund', 'Arbitrage Fund'],
      'correctAnswer': 1,
    },
    {
      'question':
          'What is the lock-in period for an Equity Linked Savings Scheme (ELSS)?',
      'options': ['1 year', '3 years', '5 years', '10 years'],
      'correctAnswer': 1,
    },
    {
      'question':
          'Which of the following funds is categorized as a debt fund with a maturity of 1 day?',
      'options': [
        'Liquid Fund',
        'Overnight Fund',
        'Gilt Fund',
    ...
    {
      'question':
          'In a Large & Mid Cap Fund, what is the minimum required investment in large cap stocks?',
      'options': ['35%', '50%', '65%', '80%'],
      'correctAnswer': 0,
    },
    {
      'question':
          'Which type of mutual fund has a minimum of 95% investment in a particular index?',
      'options': [
        'Fund of Funds',
    ...
    {
      'question':
          'A Conservative Hybrid Fund must invest what percentage in equity & equity-related instruments?',
      'options': ['10% to 25%', '40% to 60%', '65% to 80%', '0% to 10%'],
      'correctAnswer': 0,
    },
    {
      'question':
          'Which fund category invests in multiple asset classes with at least 10% allocation in each asset class?',
      'options': [
        'Dynamic Bond Fund',
        'Arbitrage Fund',
    ...
    {
      'question':
          'What is the maximum number of stocks that a Focused Fund can hold?',
      'options': ['20', '25', '30', '40'],
      'correctAnswer': 2,
    },
  ];
  ...
  final List<Map<String, Object>> quizSixQuestions = [
    {
      'question':
          'What is one of the main advantages of investing in a mutual fund?',
      'options': [
        'Guaranteed returns',
        'No risk of loss',
    ...
    {
      'question':
          'How long is the lock-in period for units of ELSS mutual funds?',
    ...
    {
      'question':
          'Which of the following is a standard risk factor associated with mutual fund investments?',
      'options': [
        'Guaranteed returns',
    ...
    {
      'question':
          'What kind of risk refers to the inability of an issuer to meet interest or principal payments?',
      'options': ['Credit Risk', 'Market Risk', 'Liquidity Risk', 'Event Risk'],
      'correctAnswer': 0,
    },
    {
      'question':
          'What happens to the market value of fixed income securities when interest rates rise?',
      'options': [
        'It remains constant',
        'It increases',
        'It decreases',
  ...
  final List<Map<String, Object>> quizSevenQuestions = [
    ...
    {
      'question':
          'Which of the following is the first step when starting an SIP?',
      'options': [
    ...
    {
      'question':
          'What is the most common investment frequency chosen by salaried investors in an SIP?',
      'options': ['Weekly', 'Quarterly', 'Monthly', 'Annually'],
      'correctAnswer': 2,
    },
    {
      'question':
          'What key benefit does SIP provide during periods of market volatility?',
      'options': [
        'Consistent returns',
    ...
    {
      'question':
          'What is the major advantage of starting to invest early in an SIP?',
      'options': [
    ...
    {
      'question':
          'Which type of SIP allows for periodic increases in contribution amounts?',
      'options': ['Fixed SIP', 'Perpetual SIP', 'Top-up SIP', 'Flexible SIP'],
      'correctAnswer': 2,
    },
    {
      'question':
          'In a flexible SIP, what aspect of contributions can be adjusted by the investor?',
      'options': [
        'Type of mutual fund',
  ...
  final List<Map<String, Object>> quizEightQuestions = [
    ...
    {
      'question':
          'Which financial tool is particularly useful for calculating XIRR?',
      'options': [
    ...
    {
      'question':
          'What type of investment strategy is XIRR particularly useful for evaluating?',
      'options': [
    ...
    {
      'question':
          'In Excel, what does the "Values" parameter in the XIRR function represent?',
      'options': [
  ...
  final List<Map<String, Object>> quizNineQuestions = [
    {
      'question':
          'What is the LTCG tax rate for equity-oriented mutual funds sold on or after July 23, 2024?',
      'options': ['10%', '12.50%', '15%', '20%'],
      'correctAnswer': 1,
    },
    {
      'question':
          'For debt-oriented mutual funds acquired before April 1, 2023, and sold before July 23, 2024, what is the LTCG tax rate?',
      'options': [
    ...
    {
      'question':
          'What is the holding period for LTCG in equity-oriented mutual funds?',
      'options': [
        'More than 6 months',
        'More than 12 months',
        'More than 24 months',
    ...
    {
      'question':
          'For hybrid mutual funds sold on or after July 23, 2024, what is the LTCG tax rate?',
      'options': ['10%', '12.50%', '15%', '20% with indexation benefit'],
      'correctAnswer': 1,
    },
    {
      'question':
          'What is the tax treatment for dividends received from mutual funds after March 31, 2020?',
      'options': [
    ...
    {
      'question':
          'What is the TDS rate on dividend income exceeding ₹5,000 in a financial year?',
      'options': ['5%', '10%', '15%', '20%'],
      'correctAnswer': 1,
    },
    {
    ...
    {
      'question':
          'What is the tax treatment for debt-oriented mutual funds acquired after April 1, 2023?',
      'options': [
    ...
    {
      'question':
          'Under what section of the Income Tax Act is the LTCG tax on equity-oriented mutual funds charged?',
      'options': [
        'Section 80C',
        'Section 111A',
        'Section 112A',
    ...
    {
      'question':
          'What is the definition of a "specified mutual fund" as per the amended Finance (No. 2) Act 2024, applicable from FY 2025-26?',
      'options': [
  ...
  final List<Map<String, Object>> quizTenQuestions = [
    ...
    {
      'question':
          'What does AMFI stand for in the context of mutual fund investments?',
      'options': [
    ...
    {
      'question':
          'Which of the following is NOT a way to invest in mutual funds?',
      'options': [
    ...
    {
      'question':
          'What certification must Mutual Fund Distributors obtain before engaging in the sale of mutual fund products?',
      'options': [
    ...
    {
      'question':
          'Through which stock exchange platform can investors buy mutual fund units?',
      'options': [
        'NSE - MFSS only',
        'BSE - StAR MF only',
    ...
    {
      'question':
          'What type of document is typically NOT accepted as a photo ID for KYC purposes?',
      'options': ['Passport', 'Aadhaar card', 'PAN card', 'Library card'],
      'correctAnswer': 3,
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          backgroundColor: const Color(0xFFDDE0F5), title: Text("Quizes")),
      body: Container(
                ...
                QuizButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                QuizPage(questions: quizOneQuestions)));
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => QuizPage(
                            questions:
                                quizTwoQuestions), // Pass quiz two questions
                      ),
                    );
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => QuizPage(
                            questions:
                                quizThreeQuestions), // Pass quiz two questions
                      ),
                    );
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => QuizPage(
                            questions:
                                quizFourQuestions), // Pass quiz two questions
                      ),
                    );
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => QuizPage(
                            questions:
                                quizFiveQuestions), // Pass quiz two questions
                      ),
                    );
                    // Navigate to Invest Ethics II quiz page
                  },
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => QuizPage(
                            questions:
                                quizSixQuestions), // Pass quiz two questions
                      ),
                    );
                    // Navigate to Invest Ethics II quiz page
                  },
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => QuizPage(
                            questions:
                                quizSevenQuestions), // Pass quiz two questions
                      ),
                    );
                    // Navigate to Invest Ethics II quiz page
                  },
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => QuizPage(
                            questions:
                                quizEightQuestions), // Pass quiz two questions
                      ),
                    );
                    // Navigate to Invest Ethics II quiz page
                  },
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => QuizPage(
                            questions:
                                quizNineQuestions), // Pass quiz two questions
                      ),
                    );
                    // Navigate to Invest Ethics II quiz page
                  },
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => QuizPage(
                            questions:
                                quizTenQuestions), // Pass quiz two questions
                      ),
                    );
                    // Navigate to Invest Ethics II quiz page
                  },
